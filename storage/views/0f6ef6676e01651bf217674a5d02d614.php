...
<?php \Core\View::startSection('title', 'Giriş Yap'); ?>
...
<div class="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-xl border border-slate-100">
    <div>
        ...
        <p class="mt-2 text-center text-sm text-slate-600">
            Veya <a href="<?php echo e(route('auth.register') ?? ""); ?>"
    ...
    <form class="mt-8 space-y-6" action="<?php echo e(route('auth.login.store') ?? ""); ?>" method="POST">
