...
<?php \Core\View::startSection('title', 'Yeni Kullanıcı Ekle'); ?>
...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <form action="<?php echo e(route('admin.users.store') ?? ""); ?>" method="POST" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <!-- Main Form -->
