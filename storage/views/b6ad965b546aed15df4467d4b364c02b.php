...
<?php \Core\View::startSection('title', 'Kullanıcı Yönetimi'); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-emerald-50 border-emerald-500 border-l-4 p-4 rounded-r-xl shadow-sm">
        <div class="flex items-center gap-3">
            ...
            <p class="text-sm text-emerald-800 font-semibold"><?php echo e(flash('success') ?? ""); ?></p>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="bg-red-50 border-red-500 border-l-4 p-4 rounded-r-xl shadow-sm">
        <div class="flex items-center gap-3">
            ...
            <p class="text-sm text-red-800 font-semibold"><?php echo e(flash('error') ?? ""); ?></p>
        </div>
    </div>
    <?php endif; ?>
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-xs text-slate-500">@ <?php echo e($user['username'] ?? '' ?? ""); ?></div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4">
                            <span
                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold <?php echo e(($user['role'] ?? '') === 'admin' ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700' ?? ""); ?>">
                        ...
                        <td class="px-6 py-4 text-sm text-slate-500">
                            <?php echo e(date('d.m.Y', strtotime($user['created_at'] ?? 'now')) ?? ""); ?>
                        </td>
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <a href="<?php echo e(route('admin.users.edit', ['id' => $user['id'] ?? 0]) ?? ""); ?>"
                                ...
                                <form action="<?php echo e(route('admin.users.delete', ['id' => $user['id'] ?? 0]) ?? ""); ?>"
