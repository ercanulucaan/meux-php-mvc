    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-slate-500 text-sm">{{ $user['name'] }} kullanıcısının bilgilerini güncelleyin.</p>
            </div>
        </div>
    </div>
                ...
                <div class="space-y-4">
                    <div class="space-y-2">
                        ...
                        <select name="role"
                            ...
                            <option value="user" {{ ($user['role'] ?? '' )==='user' ? 'selected' : '' }}>Standart
                                Kullanıcı</option>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-4 py-2">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="status" value="1" class="sr-only peer" {!! $user['status']
                                    ? 'checked' : '' !!}>
                                <div
